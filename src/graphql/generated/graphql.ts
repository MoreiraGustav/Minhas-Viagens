...
export type HtmlTextConnection = {
  ...
  aggregate: Aggregate;
  /** A list of edges. */
  edges: Array<HtmlTextEdge>;
  /** Information to aid in pagination. */
  pageInfo: PageInfo;
};

export type HtmlTextCreateInput = {
  description?: InputMaybe<Scalars['RichTextAST']['input']>;
};

export type HtmlTextCreateWithPositionInput = {
  /** Document to create */
  data: HtmlTextCreateInput;
  /** Position in the list of existing component instances, will default to appending at the end of list */
  position?: InputMaybe<ConnectPositionInput>;
};

/** An edge in a connection. */
export type HtmlTextEdge = {
  __typename?: 'HtmlTextEdge';
  /** A cursor for use in pagination. */
  cursor: Scalars['String']['output'];
  /** The item at the end of the edge. */
  node: HtmlText;
...
/** Identifies documents */
export type HtmlTextManyWhereInput = {
  /** Logical AND on all given filters. */
  AND?: InputMaybe<Array<HtmlTextWhereInput>>;
  /** Logical NOT on all given filters combined by AND. */
  NOT?: InputMaybe<Array<HtmlTextWhereInput>>;
  /** Logical OR on all given filters. */
  OR?: InputMaybe<Array<HtmlTextWhereInput>>;
  /** Contains search across all appropriate fields. */
  _search?: InputMaybe<Scalars['String']['input']>;
  id?: InputMaybe<Scalars['ID']['input']>;
  /** All values containing the given string. */
...
export enum HtmlTextOrderByInput {
  IdAsc = 'id_ASC',
  IdDesc = 'id_DESC'
}

export type HtmlTextUpdateInput = {
  description?: InputMaybe<Scalars['RichTextAST']['input']>;
};

export type HtmlTextUpdateManyInput = {
  description?: InputMaybe<Scalars['RichTextAST']['input']>;
};

export type HtmlTextUpdateManyWithNestedWhereInput = {
  /** Update many input */
  data: HtmlTextUpdateManyInput;
  /** Document search */
  where: HtmlTextWhereInput;
};

export type HtmlTextUpdateWithNestedWhereUniqueAndPositionInput = {
  /** Document to update */
  data?: InputMaybe<HtmlTextUpdateInput>;
  /** Position in the list of existing component instances, will default to appending at the end of list */
  position?: InputMaybe<ConnectPositionInput>;
  /** Unique component instance search */
  where: HtmlTextWhereUniqueInput;
};

export type HtmlTextUpdateWithNestedWhereUniqueInput = {
  /** Document to update */
  data: HtmlTextUpdateInput;
  /** Unique document search */
  where: HtmlTextWhereUniqueInput;
};

export type HtmlTextUpsertInput = {
  /** Create document if it didn't exist */
  create: HtmlTextCreateInput;
  /** Update document if it exists */
  update: HtmlTextUpdateInput;
};

export type HtmlTextUpsertWithNestedWhereUniqueAndPositionInput = {
  /** Document to upsert */
  data?: InputMaybe<HtmlTextUpsertInput>;
  /** Position in the list of existing component instances, will default to appending at the end of list */
  position?: InputMaybe<ConnectPositionInput>;
  /** Unique component instance search */
  where: HtmlTextWhereUniqueInput;
...
export type HtmlTextUpsertWithNestedWhereUniqueInput = {
  /** Upsert data */
  data: HtmlTextUpsertInput;
  /** Unique document search */
  where: HtmlTextWhereUniqueInput;
};

/** Identifies documents */
export type HtmlTextWhereInput = {
  /** Logical AND on all given filters. */
  AND?: InputMaybe<Array<HtmlTextWhereInput>>;
  /** Logical NOT on all given filters combined by AND. */
  NOT?: InputMaybe<Array<HtmlTextWhereInput>>;
...
/** References HtmlText record uniquely */
export type HtmlTextWhereUniqueInput = {
  id?: InputMaybe<Scalars['ID']['input']>;
};
